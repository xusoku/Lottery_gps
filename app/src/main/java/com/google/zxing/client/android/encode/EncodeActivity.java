...
public final class EncodeActivity extends Activity {
    ...
    private void share() {
        ...
        int halfWidth = (int) (IMAGE_HALFWIDTH * metrics.density);
        Bitmap logo = ((BitmapDrawable) getResources().getDrawable(R.mipmap.ic_launcher))
                .getBitmap();
        QRCodeImageBuilder builder = new QRCodeImageBuilder();
        builder.setLogo(logo, halfWidth);

        Bitmap bitmap;
        try {
            bitmap = encoder.encodeAsBitmap();
            //TODO 4 step
            bitmap = builder.mergeBitmap(bitmap).getTargetBitmap();
    ...
    protected void onResume() {
        ...
        try {
            ...
            qrCodeEncoder = new QRCodeEncoder(this, intent, smallerDimension, useVCard, ErrorCorrectionLevel.M);
