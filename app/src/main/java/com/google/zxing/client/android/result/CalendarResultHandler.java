...
public final class CalendarResultHandler extends ResultHandler {
   ...
   * @param start   The startActivity time
   * @param allDay  if true, event is considered to be all day starting from startActivity time
  ...
  public CharSequence getDisplayContents() {
    ...
    if (end != null) {
      if (calResult.isEndAllDay() && !start.equals(end)) {
        ...
        // But don't do it if the event already (incorrectly?) specifies the same startActivity/end
